...
class ShoppingCartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post shopping_carts_url, params: { shopping_cart: { deleted: @shopping_cart.deleted, product_id: @shopping_cart.product_id, product_q: @shopping_cart.product_q, sale_id: @shopping_cart.sale_id, subtotal: @shopping_cart.subtotal } }
    end
  ...
  test "should update shopping_cart" do
    patch shopping_cart_url(@shopping_cart), params: { shopping_cart: { deleted: @shopping_cart.deleted, product_id: @shopping_cart.product_id, product_q: @shopping_cart.product_q, sale_id: @shopping_cart.sale_id, subtotal: @shopping_cart.subtotal } }
